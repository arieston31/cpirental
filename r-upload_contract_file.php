...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['contract_files'])) {
    ...
    if (!empty($uploaded_files)) {
        ...
        $update_sql = "UPDATE rental_contracts SET contract_file = '$file_list' WHERE id = $contract_id";
    ...
    <div class="container">
                ...
                ?>
                    <div class="file-item">
                        ...
                        <div class="file-actions">
                            ...
                            <a href="r-delete_contract_file.php?contract_id=<?php echo $contract_id; ?>&file=<?php echo urlencode($file); ?>" 
        ...
        <form id="uploadForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="action-buttons">
                <a href="r-view_contracts.php" class="btn btn-secondary">← Back to Contracts</a>
